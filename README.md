...
The Zephyr Home Automation application is a MQTT client, enabling it to both send MQTT PUBLISH messages and receive MQTT SUBSCRIBE messages from the MQTT broker. Additionally, it utilizes GPIO capabilities to allow manual toggling of electrical appliances connected to the device. This application is compatible with MQTT version 3.1.1
